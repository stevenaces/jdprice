...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='jdPrice/login.html'), name='user_login'),
    # path('logout/', auth_views.LogoutView.as_view(template_name='account/logout.html'), name='user_logout'),
    path('logout/', auth_views.LogoutView.as_view(template_name='jdPrice/logout.html'), name='user_logout'),
    # path('register/', views.register, name='user_register'),
    path('register/', auth_views.LogoutView.as_view(template_name='jdPrice/register.html'), name='user_register'),
